"""StockFinancialAI - specialist AI for financial services stocks only.
...
Run: uvicorn main:app --port 8106
"""
...
CONFIG = SpecialistConfig(
    model_name="StockFinancialAI",
    model_version="0.1.0",
    asset_type="Stock",
    category="Financial",
    purpose="Mock price-movement, risk, and opportunity signals for banks and financial services stocks only.",
)

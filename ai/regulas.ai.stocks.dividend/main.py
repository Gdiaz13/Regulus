"""StockDividendAI - specialist AI for dividend stocks only.
...
Run: uvicorn main:app --port 8105
"""
...
CONFIG = SpecialistConfig(
    model_name="StockDividendAI",
    model_version="0.1.0",
    asset_type="Stock",
    category="Dividend",
    purpose="Mock price-movement, risk, and opportunity signals for dividend stocks only.",
)

"""StockSemiconductorAI - specialist AI for semiconductor stocks only.
...
Run: uvicorn main:app --port 8102
"""
...
CONFIG = SpecialistConfig(
    model_name="StockSemiconductorAI",
    model_version="0.1.0",
    asset_type="Stock",
    category="Semiconductor",
    purpose="Mock price-movement, risk, and opportunity signals for semiconductor stocks only.",
)

"""StockHealthcareAI - specialist AI for healthcare and biotech stocks only.
...
Run: uvicorn main:app --port 8107
"""
...
CONFIG = SpecialistConfig(
    model_name="StockHealthcareAI",
    model_version="0.1.0",
    asset_type="Stock",
    category="Healthcare",
    purpose="Mock price-movement, risk, and opportunity signals for healthcare and biotechnology stocks only.",
)

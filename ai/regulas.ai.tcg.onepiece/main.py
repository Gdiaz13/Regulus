"""OnePieceAI - specialist AI for One Piece TCG cards only.
...
Run: uvicorn main:app --port 8113
"""
...
CONFIG = SpecialistConfig(
    model_name="OnePieceAI",
    model_version="0.1.0",
    asset_type="TcgCard",
    category="One Piece",
    purpose="Mock price-movement, risk, and opportunity signals for One Piece cards only.",
)

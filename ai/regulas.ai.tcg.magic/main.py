"""MagicAI - specialist AI for Magic TCG cards only.
...
Run: uvicorn main:app --port 8112
"""
...
CONFIG = SpecialistConfig(
    ...
    asset_type="TcgCard",
    category="Magic",
    purpose="Mock price-movement, risk, and opportunity signals for Magic cards only.",
)

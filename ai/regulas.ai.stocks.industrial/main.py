"""StockIndustrialAI - specialist AI for industrial stocks only.
...
Run: uvicorn main:app --port 8109
"""
...
CONFIG = SpecialistConfig(
    model_name="StockIndustrialAI",
    model_version="0.1.0",
    asset_type="Stock",
    category="Industrial",
    purpose="Mock price-movement, risk, and opportunity signals for industrials, manufacturing, and transport stocks only.",
)

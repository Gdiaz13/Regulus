"""StockMemoryAI - specialist AI for memory and storage stocks only.
...
Run: uvicorn main:app --port 8104
"""
...
CONFIG = SpecialistConfig(
    model_name="StockMemoryAI",
    model_version="0.1.0",
    asset_type="Stock",
    category="Memory",
    purpose="Mock price-movement, risk, and opportunity signals for memory and storage stocks only.",
)
